...
public class WarmUpProject {
	public static void main(String[] args) throws FileNotFoundException {
		...
		int i = 0;
		String filename = "C:\\Users\\glaze\\OneDrive\\Documents\\Computer Science\\warmUpProject\\studentList.txt";
		...
		String a = "0";
		while(!a.equals(-1)) { //O(n) goes however many times the user keeps it running until a = -1
			a = sc.next();
			switch(a) {
